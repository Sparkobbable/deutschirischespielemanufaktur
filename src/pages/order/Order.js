    ...
    return (
        <> {language === 'de' ? <>
                ...
                <div className="mt-5">
                    ...
                    <p className="text-lg mt-3">
                        Eine Abholung in <span className="font-bold"> Bad Soden</span> oder <span
                        className="font-bold">Kelkheim</span> ist nach Absprache ebenfalls möglich –
            ...
            <>
                ...
                <div className="mt-5">
                    <p className="text-lg">
                        „Celebrate Magical Memories“ is a perfect gift for Christmas, Secret Santa, New Year‘s Eve, or just for yourself.
                    </p>
                    <p className="text-lg">
                        <span className="font-bold">Price: </span>{" "}€{item.price} plus shipping (available for shipping in the EU only).
                    </p>
                    <p className="text-lg mt-3">
                        After your order, you will receive all details promptly, and the game will be shipped immediately after payment.
                    </p>
                    <p className="text-lg mt-3">
                        Pickup is also possible in <span className="font-bold"> Bad Soden</span> or <span
                        className="font-bold">Kelkheim</span> by prior arrangement – just indicate this in your order.
                    </p>
                    <div className="overflow-x-auto w-full lg:w-1/4 mr-auto bg-background mt-5">
                        <table className="table border border-solid border-1 border-grey">
                            <thead className="bg-headline">
                    ...
                    <p className="text-xs">
                        Please contact us at spielemanufaktur@outlook.com to enquire about shipping costs
                        for larger quantities or delivery outside Germany.
                    </p>
                </div>
                <div className="mt-5 w-full text-center">
				<span className="text-headline text-lg">
                    ...
                    ></img>
                    <div className="flex mx-auto lg:w-1/3 w-3/4 mt-5 justify-between">
                        <p className="mr-4 translate-y-2">Price: </p>
                        <span className="text-headline text-lg">
						{item.price} €
					</span>
                    </div>
                    <div className="flex mx-auto lg:w-1/3 w-3/4 mt-5 justify-between">
                        <p className="mr-4 translate-y-2">Quantity: </p>
                        <input
                            type="number"
                            placeholder="Quantity"
                            className="input input-bordered w-4/5"
                            aria-label="Quantity of games"
                            value={quantity}
                            onChange={(e) => setQuantity(e.target.valueAsNumber)}
                            min={1}
                        />
                    ...
                    <h1 className="text-headline text-2xl font-bold">
                        Play, reminisce, share your stories – and let the magic of memories unfold!
                    </h1>
                </div>
            </>}
        </>
